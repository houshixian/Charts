...
- (id)initWithHistogram:(ISSChartHistogramData*)histogram
{
    ...
    if (self) {
        ...
        _legendTextArray = histogram.legendTextArray;
        _legends = histogram.legends ;
        _legendPosition = histogram.legendPosition;
		_barStrokColors = histogram.barStrokColors;
		_barFillColors = histogram.barFillColors;
		_barGroupDatas = histogram.barGroupDatas;
    }
    return self;
}
