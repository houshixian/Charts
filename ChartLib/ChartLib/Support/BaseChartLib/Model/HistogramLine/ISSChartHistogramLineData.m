...
- (id)initWithHistogramLineData:(ISSChartHistogramLineData*)histogramLineData
{
    ...
    if (self) {
        ...
        _barGroupDatas = histogramLineData.barGroupDatas ;
		_barStrokColors = histogramLineData.barStrokColors ;
		_barFillColors = histogramLineData.barFillColors ;
		
        _histogramStyle = histogramLineData.histogramStyle;
        _legendTextArray = histogramLineData.legendTextArray;
        _legends = histogramLineData.legends;
        ...
        _lineColors = histogramLineData.lineColors;
...
- (void)generateBars
{
    ...
    for (NSInteger groupIndex = 0; groupIndex < groupCount; groupIndex++) {
        ...
        for (NSInteger index = 0; index < barCount; index++) {
            ...
            bar.valueY = [groupData[index] doubleValue];
