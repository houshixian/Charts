...
- (ISSChartHintView*)dequeueHintViewWithIdentifier:(NSString*)identifier
{
    ...
    if (hintViewsSet) {
        hintView = [hintViewsSet anyObject];
		if (hintView) {
...
{
    [self animationWithData:chartData completion:NULL];
}
...
//        [self.delegate handleSingleTap:gestureRecognizer];
//    }
//    
//
